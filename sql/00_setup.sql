...
--   2. Change the two UTC dates in the REVIEW_SETTINGS seed below. (Tip: run the
--      activity profiling query in 01_preflight.sql to pick an active window).
...
--
-- Session note for Snowflake Notebooks: all SQL cells in a notebook share the same
-- session, so temporary tables created in steps 04 and 06 survive across cells.
--
